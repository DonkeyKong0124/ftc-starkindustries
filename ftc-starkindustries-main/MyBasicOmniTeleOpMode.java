...
public class MyBasicOmniTeleOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        rightFrontWheel = hardwareMap.get(DcMotor.class, "right_front"); // Forward
        rightRearWheel = hardwareMap.get(DcMotor.class, "right_rear"); // Forward
        leftFrontWheel = hardwareMap.get(DcMotor.class, "left_front"); // Backward
        leftRearWheel = hardwareMap.get(DcMotor.class, "left_rear"); // Backward

        towerArm = hardwareMap.get(DcMotor.class, "tower_arm");
        ...
        while (opModeIsActive()) {
            ...
            // Power for MOVING
            double movePower = axialPower + lateralPower + yawPower;

            // Set motor power for drivetrain.
            rightFrontWheel.setPower(movePower);
            rightRearWheel.setPower(movePower);
            leftFrontWheel.setPower(movePower);
            leftRearWheel.setPower(movePower);
